...
alert("Bienvenidos a la nueva era de compra online");
...
alert("A continuación podrás realizar tus compras");

let comprar = prompt(nombreUsuario + " acá podrás escoger entre nuestros productos que tenemos en stock \n 1-Laptop gamer \n 2-Mouse inalambrico \n 3-Teclado inalambrico");
